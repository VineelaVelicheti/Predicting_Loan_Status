...
print("KNN F-1 score(micro) = ", F1_Knn)

F1W_Knn = f1_score(Y_test,pred_KNN,average = 'weighted')
print("KNN F-1 score(weighted) = ", F1W_Knn)
...
start_time = time.clock()
GaussianNB_model = GaussianNB().fit(Train_PCA,Y_train)
pred_naive = GaussianNB_model.predict(Test_PCA)
...
MLP_model = MLP_model.fit(Train_PCA,Y_train)
...
grad = grad.fit(Train_PCA,Y_train)
pred_grad = grad.predict(Test_PCA)
...
RF = RF.fit(Train_PCA,Y_train)
pred_RF = RF.predict(Test_PCA)
...
extra_trees = extra_trees.fit(Train_PCA,Y_train)
pred_ext = extra_trees.predict(Test_PCA)
...
AdaB_model = AdaB_model.fit(Train_PCA,Y_train)
pred_Adab = AdaB_model.predict(Test_PCA)
...
XGB_model = XGB_model.fit(Train_PCA,Y_train)
pred_XGB = XGB_model.predict(Test_PCA)
...
plt.ylabel('Accuracy')
plt.title('Accuracy Comparison Between All Algorithms (PCA)')

plt.savefig('/Users/vineevineela/Downloads/220_Assignment/Images/Accuracy_PCA.svg',bbox_inches = "tight")
plt.clf()
...
plt.title('F1_score(Micro) Comparison Between All Algorithms  (PCA)')

plt.savefig('/Users/vineevineela/Downloads/220_Assignment/Images/F1_Micro_PCA.svg',bbox_inches = "tight")
plt.clf()
...
plt.xlabel("Algorithms")
plt.title('F1_score(Weighted) Comparison Between All Algorithms  (PCA)')

plt.savefig('/Users/vineevineela/Downloads/220_Assignment/Images/F1_Weighted_PCA.svg',bbox_inches = "tight")
plt.clf()
...
plt.xlabel("Algorithms")
plt.title('Comparison of All Metrics(PCA)')
plt.legend()

plt.savefig('/Users/vineevineela/Downloads/220_Assignment/Images/Metrics_PCA.svg',bbox_inches = "tight")
plt.clf()
...
plt.savefig('/Users/vineevineela/Downloads/220_Assignment/Images/CPU_Per_PCA.svg',bbox_inches = "tight")
plt.clf()
...
plt.savefig('/Users/vineevineela/Downloads/220_Assignment/Images/Mem_Usage_PCA.svg',bbox_inches = "tight")
plt.clf()
...
plt.savefig('/Users/vineevineela/Downloads/220_Assignment/Images/Latency_Time_PCA.svg',bbox_inches = "tight")
plt.clf()
...
Dec_cv = cross_val_score(dec,Train_PCA,Y_train,cv=3).mean()
