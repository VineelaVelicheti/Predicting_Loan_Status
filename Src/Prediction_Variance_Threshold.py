...
variance_selector = variance_selector.fit(train_data)

Train_var = variance_selector.transform(train_data)
print(Train_var.shape)

Test_var = variance_selector.transform(test_data)
...
dec.fit(Train_var,Y_train)
pred_dec = dec.predict(Test_var)
...
knn.fit(Train_var,Y_train)
pred_KNN = knn.predict(Test_var)
...
start_time = time.clock()
SGD_model = SGDClassifier().fit(Train_var,Y_train)
pred_sgd = SGD_model.predict(Test_var)
...
start_time = time.clock()
GaussianNB_model = GaussianNB().fit(Train_var,Y_train)
pred_naive = GaussianNB_model.predict(Test_var)
...
MLP_model = MLP_model.fit(Train_var,Y_train)
pred_mlp = MLP_model.predict(Test_var)
...
grad = grad.fit(Train_var,Y_train)
pred_grad = grad.predict(Test_var)
...
RF = RF.fit(Train_var,Y_train)
pred_RF = RF.predict(Test_var)
...
extra_trees = extra_trees.fit(Train_var,Y_train)
pred_ext = extra_trees.predict(Test_var)
...
AdaB_model = AdaB_model.fit(Train_var,Y_train)
pred_Adab = AdaB_model.predict(Test_var)
...
XGB_model = XGB_model.fit(Train_var,Y_train)
pred_XGB = XGB_model.predict(Test_var)
...
plt.ylabel('Accuracy')
plt.title('Accuracy Comparison Between All Algorithms (VT)')

plt.savefig('/Users/vineevineela/Downloads/220_Assignment/Images/Accuracy_Var.svg',bbox_inches = "tight")
plt.clf()
...
plt.title('F1_score(Micro) Comparison Between All Algorithms  (VT)')

plt.savefig('/Users/vineevineela/Downloads/220_Assignment/Images/F1_Micro_Var.svg',bbox_inches = "tight")
plt.clf()
...
plt.title('F1_score(Weighted) Comparison Between All Algorithms  (VT)')

plt.savefig('/Users/vineevineela/Downloads/220_Assignment/Images/F1_Weighted_Var.svg',bbox_inches = "tight")
plt.clf()
...
plt.xlabel("Algorithms")
plt.title('Comparison of All Metrics(VT)')
plt.legend()

plt.savefig('/Users/vineevineela/Downloads/220_Assignment/Images/Metrics_Var.svg',bbox_inches = "tight")
plt.clf()
...
plt.title('CPU Per(%) Comparison between all algorithms (VT)')

plt.savefig('/Users/vineevineela/Downloads/220_Assignment/Images/CPU_Per_Var.svg',bbox_inches = "tight")
plt.clf()
...
plt.title('Memory Usage Comparison between all algorithms (VT)')

plt.savefig('/Users/vineevineela/Downloads/220_Assignment/Images/Mem_Usage_Var.svg',bbox_inches = "tight")
plt.clf()
...
plt.xlabel("Algorithms")
plt.title('Latency Time Comparison Between All Algorithms (VT)')

plt.savefig('/Users/vineevineela/Downloads/220_Assignment/Images/Latency_Time_Var.svg',bbox_inches = "tight")
plt.clf()
...
Dec_cv = cross_val_score(dec,Train_var,Y_train,cv=3).mean()
